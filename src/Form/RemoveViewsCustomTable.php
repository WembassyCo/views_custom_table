...
class RemoveViewsCustomTable extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($result) {
      \Drupal::messenger()->addMessage($this->t('@table is removed from views custom table data.', [
        '@table' => $table_name,
      ]));
    }
    else {
      \Drupal::messenger()->addMessage($this->t('Could not remove table from views view_custom_table.tables, please check log messages for error.'), 'error');
    }
