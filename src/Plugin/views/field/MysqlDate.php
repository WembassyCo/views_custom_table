 ...
 */
class MysqlDate extends FieldPluginBase {
  ...
  public function render(ResultRow $values) {
    ...
    if ($value) {
      ...
      switch ($format) {
        ...
        case 'custom':
          if ($custom_format == 'r') {
            return Drupal::service('date.formatter')->format($value, $format, $custom_format, $timezone, 'en');
          }
          return Drupal::service('date.formatter')->format($value, $format, $custom_format, $timezone);

        default:
          return Drupal::service('date.formatter')->format($value, $format, '', $timezone);
      }
    }
  }
